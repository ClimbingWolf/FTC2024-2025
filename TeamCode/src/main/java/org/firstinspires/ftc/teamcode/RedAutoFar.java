...
public class RedAutoFar extends LinearOpMode {
    ...
    public double blarmOffset = pidConstantsAndFunctions.blarmOffset;
    ...
    public double servoOffsetTop = pidConstantsAndFunctions.servoOffsetTop;
    ...
    public double posA = pidConstantsAndFunctions.posA;
    public double posB = pidConstantsAndFunctions.posB;
    ...
    public double turnMacroSpeed= 0.3;
    ...
    public void runOpMode() {
        ...
        rlr = readFromFile(fileStart + "rlr.txt");
        rlm = readFromFile(fileStart +"rlm.txt");
        rll = readFromFile(fileStart +"rll.txt");
        ...
        while (opModeIsActive()) {
            ...
            if(frame < byteArrList.size() && frame > -1) {
                ...
                afghm.setPower(tempGamepad.right_stick_x);

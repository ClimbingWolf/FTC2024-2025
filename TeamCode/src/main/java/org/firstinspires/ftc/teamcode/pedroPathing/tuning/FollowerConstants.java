...
public class FollowerConstants {
    ...
    public static String leftFrontMotorName = "fleft";
    public static String leftRearMotorName = "bleft";
    public static String rightFrontMotorName = "fright";
    public static String rightRearMotorName = "bright";

...
public class CameraDetectPipeline extends OpenCvPipeline{
    public double nonZero = 0;
    public String position = "";
    public Scalar rectRed = new Scalar (255,100,100);

    public Scalar rectGreen = new Scalar(120, 255, 255);
    public Scalar redLower = new Scalar (0,128,80);

    public Scalar redUpper = new Scalar (25,255,255);
    ...
    public Point p1r2= new Point(220,160);
    public Point p2r2 = new Point(320,260);
    public Point p1r3= new Point(470,160);
    public Point p2r3 = new Point(570,260);

    public Rect rectangle;
    public Rect rectangle2;
    public Rect rectangle3;
    public double rect1Count = 0;
    public double rect2Count= 0;
    public double rect3Count = 0;
    ...
    public Mat processFrame(Mat input){
        ...
        if((rect2Count < 500 && rect3Count < 500) || (rect1Count > rect2Count && rect1Count > rect3Count)){
